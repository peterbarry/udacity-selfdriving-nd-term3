      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // if starigt off and previous points is short.
            if (prev_size <2 )
            {
            ...
            else
            {
              ...
              // use points that make up tanget to the the previosu path endpoint.
            ...
            {
              // shift car refernce to angle of 0 deg.
            ...
            // define the actual way points
            std::vector<double> next_x_vals;
            std::vector<double> next_y_vals;

            // start with all the prev points from last time. - this prev path us unused points from prev submisison to sim.
            ...
            // calculate spine points to travel at desired reference. - used to averge speed later.
            ...
            for (int i =0 ; i <= 50 - previous_path_x.size();i++)
            {
              ...
              // route back to normal after roataig it earlier
...
//          	vector<double> next_x_vals_1;
//          	vector<double> next_y_vals_1;
//
//
...
//              double next_d = 10; // stay in that lane.
//              vector<double> xy = getXY(next_s, next_d, map_waypoints_s, map_waypoints_x, map_waypoints_y);
//
//              next_x_vals_1.push_back(xy[0]);
//              next_y_vals_1.push_back(xy[1]);
//
